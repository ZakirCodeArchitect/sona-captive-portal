...
export default function SuccessScreen({ registrationTime }) {
  return (
    <div className="flex flex-col items-center px-2 py-2 text-center animate-fade-in">
      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-tower-success/10">
        <CheckCircle2 className="h-7 w-7 text-tower-success" strokeWidth={1.5} />
      </div>
